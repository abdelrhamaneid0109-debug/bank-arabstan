...
module.exports = {
  data: new SlashCommandBuilder()
    .setName("خصم")
    .setDescription("خصم فلوس من عضو")
  ...
  async execute(interaction) {
    ...
    if (user[type] < amount) {
      return interaction.reply({ content: "❌ معندوش فلوس كفاية", flags: MessageFlags.Ephemeral });
    }
    ...
    return interaction.reply(`✅ تم خصم ${amount} ${type} من ${target.username}`);
  },
};
